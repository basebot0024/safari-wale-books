...
<b><blockquote>ɪ ᴀᴍ ᴀ ʙᴏᴏᴋꜱ ʙᴏᴛ ᴛʜᴀᴛ ᴘʀᴏᴠɪᴅᴇꜱ ʙᴏᴏᴋꜱ ᴀɴᴅ ᴀᴜᴅɪᴏʙᴏᴏᴋꜱ ᴡʜᴇɴᴇᴠᴇʀ ᴜꜱᴇʀꜱ ʀᴇQᴜᴇꜱᴛ ᴛʜᴇᴍ ꜰʀᴏᴍ ᴍᴇ. ᴘʟᴇᴀꜱᴇ ɴᴏᴛᴇ, ɪ ᴏɴʟʏ ᴘʀᴏᴠɪᴅᴇ ʙᴏᴏᴋꜱ ɪɴꜱɪᴅᴇ ɢʀᴏᴜᴘꜱ ᴀɴᴅ ɴᴏᴛ ᴏɴ ᴘᴇʀꜱᴏɴᴀʟ ᴍᴇꜱꜱᴀɢᴇꜱ.</blockquote>\n\n<blockquote>ᴛᴏ ɢᴇᴛ ʙᴏᴏᴋꜱ ᴘᴇʀꜱᴏɴᴀʟʟʏ ꜰʀᴏᴍ ᴍᴇ, ʏᴏᴜ ᴡɪʟʟ ʜᴀᴠᴇ ᴛᴏ ᴘᴜʀᴄʜᴀꜱᴇ ᴍʏ ᴘʀᴇᴍɪᴜᴍ ꜰɪʀꜱᴛ.</b></blockquote>
...
○ sᴇᴀʀᴄʜ ꜰɪʟᴇꜱ ᴅɪʀᴇᴄᴛʟʏ ɪɴ ᴛʜᴇ ʙᴏᴛ
○ ɴᴏ ғɪʟᴇ ʟɪᴍɪᴛs
○ ɢᴇᴛ ᴜɴʟɪᴍɪᴛᴇᴅ ғɪʟᴇs
...
ʙᴜʏ ᴘᴀɪᴅ ᴘʟᴀɴ ʙʏ - /plans</b>"""
    ...
    FSUB_TXT = """<i><b>👀 ʜᴇʟʟᴏ ᴘᴏᴏᴋɪᴇ, ʙᴇꜰᴏʀᴇ ʏᴏᴜ ɢᴇᴛ ʏᴏᴜʀ ꜰᴀᴠᴏʀɪᴛᴇ ʙᴏᴏᴋ ᴏʀ ᴀᴜᴅɪᴏʙᴏᴏᴋ, ꜱᴜᴘᴘᴏʀᴛ ᴜꜱ ʙʏ ᴊᴏɪɴɪɴɢ ᴛʜᴇ ᴄʜᴀɴɴᴇʟ ʙᴇʟᴏᴡ.
...
<code>The way of men epub</code>
<code>The Witcher</code>

ᴏɴʟʏ ɴᴀᴍᴇ ᴀɴᴅ ꜰᴏʀᴍᴀᴛ ɴᴏ ᴇxᴛʀᴀ ᴡᴏʀᴅꜱ ᴏʀ ɪɴꜰᴏ</i>"""

    I_CUD_NT = """<blockquote>ᴏʜʜ ɴᴏ ᴘᴏᴏᴋɪᴇ! 😔</blockquote>
    
ɪ ᴄᴏᴜʟᴅ ɴᴏᴛ ꜰɪɴᴅ ᴀɴʏ ꜰɪʟᴇꜱ ʀᴇʟᴀᴛᴇᴅ ᴛᴏ <i>'{}'</i>.
ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ᴏɴ ɢᴏᴏɢʟᴇ ⌛"""

    MVE_NT_FND = """<i>ᴡᴇ ᴅɪᴅ ɴᴏᴛ ғɪɴᴅ ᴀɴʏ ꜰɪʟᴇꜱ ᴡɪᴛʜ ᴛʜɪs ɴᴀᴍᴇ 🙅,

ᴛʜɪs ꜰɪʟᴇ ɴᴀᴍᴇ ʜᴀs ʙᴇᴇɴ sᴇɴᴛ ᴛᴏ ᴛʜᴇ ᴀᴅᴍɪɴ</i>..."""
...
• /request - sᴇɴᴅ ᴀ ʙᴏᴏᴋ ᴏʀ ᴀᴜᴅɪᴏʙᴏᴏᴋ ʀᴇᴏ̨ᴜᴇsᴛ ᴛᴏ ᴀᴅᴍɪɴs. 
...
ʏᴏᴜʀ ʜᴀꜱ ʙᴇᴇɴ ᴜᴘʟᴏᴀᴅᴇᴅ ᴛᴏ ᴛʜᴇ ᴅᴀᴛᴀʙᴀꜱᴇ! ✅
ꜱᴇᴀʀᴄʜ ᴀɢᴀɪɴ ᴛᴏ ɢᴇᴛ ᴛʜᴇ ꜰɪʟᴇ 🥰"""

    NOT_RELEASE_TXT = """{} 
    
ʏᴏᴜʀ ʀᴇQᴜᴇꜱᴛᴇᴅ ꜰɪʟᴇ ʜᴀꜱ ɴᴏᴛ ʙᴇᴇɴ ᴘᴜʙʟɪꜱʜᴇᴅ ᴏʀ ʀᴇʟᴇᴀꜱᴇᴅ ʏᴇᴛ.
ᴘʟᴇᴀꜱᴇ ᴡᴀɪᴛ ᴜɴᴛɪʟ ɪᴛ ɪꜱ ᴘᴜʙʟɪꜱʜᴇᴅ ᴏʀ ʀᴇʟᴇᴀꜱᴇᴅ! 👀"""

    SPELL_TXT = """{} 
ᴛʜᴇ ɴᴀᴍᴇ ʏᴏᴜ ꜱᴇɴᴛ ᴅɪᴅ ɴᴏᴛ ᴍᴀᴛᴄʜ ᴀɴʏ ꜰɪʟᴇ ᴀꜱ ᴏꜰ ɴᴏᴡ.
